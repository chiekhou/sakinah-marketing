...
import { AppAndroidLink } from './AppAndroidLink'
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Sakinah t'accompagne face au stress, au harcèlement et aux
              émotions difficiles. Un assistant IA bienveillant, disponible
              24h/24, conçu pour les jeunes qui ont besoin d'être écoutés.
            </p>
          ...
          <div className="relative -mt-4 lg:col-span-7 lg:mt-0 xl:col-span-6">
            <p className="text-center text-sm font-semibold text-gray-900 lg:text-left">
              Conçu avec soin pour les jeunes et leurs familles
            </p>
            <ul
              role="list"
              className="mx-auto mt-8 flex max-w-xl flex-wrap justify-center gap-x-8 gap-y-6 lg:mx-0 lg:justify-start"
            >
              {[
                ['Gratuit', '🆓'],
                ['Anonyme', '🛡️'],
